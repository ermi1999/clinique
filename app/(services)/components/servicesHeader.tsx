...
export default function ServicesHeader({
  ...
  return (
    <div
      ...
      ref={container}
    >
      <SmallHeadingContainer className="mt-0 py-0 md:py-0">
        {smallHeading}
      ...
      <h1 className="flex flex-col font-general-sans-medium text-2xl sm:text-4xl md:text-5xl lg:text-7xl w-full services-header">
        <span className="font-bold-italic self-center md:self-start text-[2.7rem] sm:text-6xl md:text-7xl lg:text-[7.8rem] text-nowrap">
          {italicHeader}
        </span>
        <span className="self-center md:self-end">{header}</span>
      </h1>
      <p className="w-[150px] font-medium self-center lg:self-start services-header">
        {smallText}
      </p>
    </div>
  );
