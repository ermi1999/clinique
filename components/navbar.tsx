...
export default function Navbar() {
  return (
    <nav
      className="fixed z-20 w-full text-black pt-3 font-general-sans rounded-b-full md:px-7
                "
    >
        ...
        <div
          className="space-x-10 xl:space-x-20 *:py-1
                ...
                *:whitespace-nowrap
                ...
                hover:before:*:scale-100 bg-white rounded-xl h-[3.2rem] hidden lg:flex items-center justify-center px-4 shadow-sm"
        >
